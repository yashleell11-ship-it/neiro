...
can migrate an existing ``~/.config/elizabeth/config.toml`` instead of
...
class AudioDeviceProfile(BaseModel):
    ...
    node_name_hint: str = ""  # informational, for `elizabeth doctor --audio-inventory`
...
class Elizabeth(BaseSettings):
    ...
    def settings_customise_sources(
        ...
        # `elizabeth doctor` never actually reads ~/.config/elizabeth/config.toml,
