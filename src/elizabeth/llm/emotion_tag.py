"""Parse Elizabeth's emotional state off the front of her own reply stream.
...
_NEUTRAL_FALLBACK = ElizabethState.from_label(EmotionLabel.NEUTRAL, intensity=0.5)
...
class EmotionTagParser:
    ...
    def feed(self, chunk: str) -> tuple[ElizabethState | None, str]:
        ...
        if match:
            ...
            return ElizabethState.from_label(label, intensity), remainder
    ...
    def flush(self) -> tuple[ElizabethState | None, str]:
