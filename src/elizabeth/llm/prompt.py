"""Load Elizabeth's character prompt, and keep its bytes stable.
...
def load_prompt(version: str = PROMPT_VERSION) -> str:
    ...
    if not path.exists():
        raise FileNotFoundError(
            f"Character prompt not found at {path}. Elizabeth without a character "
