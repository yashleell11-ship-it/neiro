...
from elizabeth.tts.visemes import timeline
...
class KokoroTts:
    ...
    def __init__(self, cfg: Elizabeth | None = None, voice: str = "af_heart") -> None:
    ...
    def _load(self):
        if self._pipeline is None:
            ...
            # weights on first use; `elizabeth fetch-models` pre-fetches them
