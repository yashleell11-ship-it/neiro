...
The other consumer of the same `ElizabethState` that drives the face. If the
...
def instruct_for(state: ElizabethState) -> str:
...
def exaggeration_for(state: ElizabethState, floor: float = 0.25, ceiling: float = 0.8) -> float:
