"""`elizabeth run` — the daemon that holds the loop together.
...
from elizabeth.affect.prosody import ProsodyAffectProvider, describe
from elizabeth.config import Elizabeth
from elizabeth.orchestrator import Orchestrator, TurnResult
...
from elizabeth.tools.confirm import NotificationConfirmer, decide
...
class Daemon:
    ...
    def __init__(self, cfg: Elizabeth | None = None) -> None:
