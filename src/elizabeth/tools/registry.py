...
1. **Shape.** Every tool's arguments are a pydantic model with
   ...
   a window, an app or a unit takes an integer index into a list Elizabeth
...
def _field_is_safe(annotation: Any, name: str, spoken: frozenset[str]) -> str | None:
    ...
    if annotation is str:
        return (
            ...
            "reaches a command — use an int index into a list Elizabeth produced this "
...
class ToolRegistry:
    """Everything Elizabeth can do, and everything she cannot.
