...
from elizabeth.training.manifest import NON_PUBLISHABLE_FLAGS, Dataset, Manifest
...
# The six labels of her tag — prompts/elizabeth.v4.md and llm/emotion_tag.py
