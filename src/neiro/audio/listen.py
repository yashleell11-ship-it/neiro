...
`neiro talk` ends an utterance when SPACE is pressed. This is the thing
...
from neiro.audio.vad import BargeInDetector, SpeechGate, VadFrameSizeError
...
# after PipeWire's canceller, which `neiro doctor` should measure
